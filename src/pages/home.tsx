            ...
            <div className="left">
                <div className="left-top">
                    ...
                    <div className="descriptions">
                        ...
                        animate="animate"
                        transition={{...transition, duration:1, delay: 4.5}}
                        >Un Développeur Web Front-end, Créant Des Expériences Web Que Les Gens Aiment Utiliser.</motion.p>
                    </div>
                </div>
            ...
            <div className="right">
                ...
                <div className="right-bottom">
                    <motion.div className="link-container">
                        ...
                        >
                            <Link to="works"><span className="number">01.</span>Projets</Link>
                        </motion.div>
                    </motion.div>
                    <motion.div className="link-container">
                        <motion.div className="link-wrapper2"
                        variants={angleTextReveal} initial="initial" animate="animate" transition= {{...transition, duration: 1, delay: 5.2}}
                        >
                            <Link to="about"><span className="number">02.</span>À Propos De Moi</Link>
                        </motion.div>
                    </motion.div>
                    <motion.div className="link-container">
                        <motion.div className="link-wrapper"
