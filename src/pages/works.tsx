                ...
                <div className="title-wrapper">
                    ...
                    className="title">
                        <motion.h1 className="word-wrapper">
                            ...
                            className="word">Creativity,</motion.div>
                        </motion.h1>
                        <motion.h1 className="word-wrapper">
                            <motion.div
                            variants={angleTextReveal}
                            transition={transition}
                            className="word">Effort,</motion.div>
                        </motion.h1>
                        <motion.h1 className="word-wrapper">
                            <motion.div
                            variants={angleTextReveal}
                            transition={transition}
                            className="word">&#38; Lots Of Debugging.</motion.div>
                        </motion.h1>
                        <motion.p className="word-wrapper">
                            ...
                            transition={transition}
                            className="info"
                            >This is a sample of all my projects. To view all of them please visit my <a className="link" href="https://showcase.jackjona.me"><p>Showcase.</p></a>
                            </motion.div>
                        </motion.p>
                    </motion.div>
                </div>
