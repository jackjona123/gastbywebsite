                ...
                <div className="title-wrapper">
                    ...
                    className="title">
                        <motion.h1 className="word-wrapper">
                            ...
                            className="word">En Pensant</motion.div>
                        </motion.h1>
                        <motion.h1 className="word-wrapper">
                            <motion.div
                            variants={angleTextReveal}
                            transition={transition}
                            className="word"></motion.div>
                        </motion.h1>
                        <motion.h1 className="word-wrapper">
                            <motion.div
                            variants={angleTextReveal}
                            transition={transition}
                            className="word">&#38; Beaucoup De Débogage.</motion.div>
                        </motion.h1>
                        <br />
                        <motion.p className="word-wrapper">
                            <motion.div
                            variants={angleTextReveal} 
                            transition={transition}
                            className="info"
                            >Ceci Est Un Échantillon De Tous Mes Projets. Pour Les Voir Tous, Veuillez Visiter Mon <a className="link" href="https://showcase.jackjona.ga"><p>Showcase.</p></a>
                            </motion.div>
                        </motion.p>
                    </motion.div>
                </div>
