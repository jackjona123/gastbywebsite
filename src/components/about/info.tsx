    ...
    return(
        <InfoStyles data-scroll-section  className="info">
            <div className="info-main">
                ...
                <h2>Frameworks & Autres</h2>
                <p>React.js, Gatsby.js, Next.js, Firebase, Framer Motion, GSAP, Styled Components, Tailwind CSS, Git, NPM, PWA</p>
                <h2>UI/UX</h2>
                <p>Conception réactive, prototypage, Figma, Adobe Photoshop, tests d'utilisabilité</p>
                <h2>Apprentissage</h2>
                <p>Node.js, Vue.js, Python</p>
                <h2>Autres compétences</h2>
                <p>CPR/AED, Administration des systèmes, Photographie et production médiatique</p>
            ...
            <div className="info-credits">
                <br />
                <h1>Crédits</h1>
                <p>Ce site Web est construit avec React.js. & Animations optimisées par Framer Motion.</p>
                <p>Ce site Web a été inspiré par les personnes suivantes :</p>
