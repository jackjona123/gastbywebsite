    ...
    return(
        <InfoStyles data-scroll-section  className="info">
            <div className="info-main">
                ...
                <h2>Other Skills</h2>
                <p>CPR/AED, Systems Administration, Photography & Media Production</p>
            ...
            <div className="info-credits">
                <br />
                <h1>Credits</h1>
                <p>This Website Is Built With React.js. & Animations Powered By Framer Motion.</p>
                <p>This Website Was Inspried By The Following Individuals:</p>
